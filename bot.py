...
async def urban(interaction: discord.Interaction, search: str = None):
    ...
    if response.status_code == 200:
        ...
        embed = discord.Embed(
            title=f"{title}", description=description, color=discord.Color.from_str("0xDD0000")
        )
        ...
        await interaction.response.send_message("Error happened! Status code" + response.status_code)
